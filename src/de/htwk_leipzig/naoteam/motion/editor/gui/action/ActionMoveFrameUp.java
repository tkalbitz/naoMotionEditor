...
public class ActionMoveFrameUp extends AbstractAction  {
    ...
    @Inject
    ActionMoveFrameUp(IImageLoader loader, MainApplication appController) {
        super("Move frame up");
        final String name = "go-up.png";
        putValue(Action.LARGE_ICON_KEY, loader.large(name));
        putValue(Action.SMALL_ICON, loader.small(name));
        putValue(SHORT_DESCRIPTION, "Move the current Frame up");
        app = appController;
    }
