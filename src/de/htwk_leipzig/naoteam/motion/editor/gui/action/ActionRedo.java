...
public class ActionRedo extends AbstractAction implements IUndoRedoListener {

    private final MainApplication app;

    @Inject
    public ActionRedo(MainApplication appl, IImageLoader loader) {
        app = appl;
        final String name = "redo.png";
